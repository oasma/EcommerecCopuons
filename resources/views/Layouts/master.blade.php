                        ...
                        <nav class="main-menu" dir="rtl">
                            <ul>
                                ...
                                @else
                                    ...
                                    <li>
                                        <form method="POST" action="{{Route('changeLanguage','en')  }}">
                                            @csrf
                    ...
                    <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                ...
                                <h1>احدث صيحات الموضه والتسوق</h1>
                                <div class="hero-btns">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1 text-center">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                <p class="subtitle">توصيل باقل الاسعار الى باب المنزل</p>
                                <h1>100% ماكولات طبيعية</h1>
                                <div class="hero-btns">
                    ...
                    <div class="col-lg-10 offset-lg-1 text-right">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                ...
                                <h1>خصومات لا نهائيه على جميع المنتجات</h1>
                                <div class="hero-btns">
                                    <a href="shop.html" class="boxed-btn">سجل معنا</a>
                                    <a href="contact.html" class="bordered-btn">تواصل معنا</a>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>حقحوق الملكيه محفوضه لدى موقع &copy; 2024 - <a
                            href="www.Osama-Almasri.com">www.Osama-Almasri.com</a>
